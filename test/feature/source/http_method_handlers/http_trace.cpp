...
void trace_handler( const shared_ptr< Session > session )
{
...
SCENARIO( "publishing single path resources", "[resource]" )
{
    ...
    resource->set_method_handler( "TRACE", trace_handler );
    ...
    service.set_ready_handler( [ &worker ]( Service & service )
    {
        ...
        {
            GIVEN( "I publish a resource at '/resources/1' with a HTTP 'TRACE' method handler" )
            {
